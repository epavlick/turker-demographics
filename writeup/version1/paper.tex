...
\hline
workers & quality & speed & \\\hline
many &high&fast&\cellcolor[rgb]{0.5, 0.8, 0.5} bs de es fr gu hr it kn mk ml ms nl pt ro sh sr te tl\\\cline{3-4}
&&slow&af bg cy da fi ga gl he ht hu id ja lv no pa sk sv tr\\\cline{2-4}
&low &fast&hi mr ta ur\\\cline{3-4}
&&slow&am ar az bcl be bn bo bpy br ca ceb cs el eo is jv ka ko lb lt ne new nn pl ps ru scn sd so su sw uz vi wo zh\\\cline{1-4}
few &high  &fast&--\\\cline{3-4}
&&slow&an pms sl sq uk\\\cline{2-4}
&low  &fast&--\\\cline{3-4}
&&slow&\cellcolor[rgb]{0.8, 0.5, 0.5}ast diq eu fa fy hy ilo io kk ku mg nap nds pam qu th tt wa war yo\\\hline
\end{tabular}
\caption{The green box shows the languages which we have found most supported by MTurk in terms of worker population, worker ability, and speed of completion. Languages have ``many'' workers if we recorded more than 50 active turkers. Languages are ``high'' quality if they average greater than 70\% accuracy on our controls. Languages are ``fast'' if all of our translations (approx. 10,000 words each) were completed in within two weeks.}
\label{recommendations}
\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{Discussion}
Mechanical Turk gives researchers access to a diverse set of bilingual workers, making it a promising resource for researchers and developers of multilingual systems. Based on our study, we can confidently recommend 18 languages as good candidates for future research: Bosnian, German, Spanish, French, Gujarati, Croatian, Italian, Kannada, Macedonian, Malayalam, Malay, Dutch, Portuguese, Romanian, Serbo-Croatian, Serbian, Telugu, and Tagalog. These languages have large Turker populations who complete tasks quickly and accurately. Table \ref{recommendations} summarizes the strengths and weaknesses of all 100 languages covered in our study. 
