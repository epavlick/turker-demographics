...
\begin{figure*}[h]
\centering
\includegraphics[width=7in]{figures/completiontime}
\caption{Time (in days) to complete all HITs in each language. Red bar shows time until first HIT was started, relative to the time the first HIT in each language was started, relative to the time the first HIT in any language was started (first HIT started across all languages was Urdu). Blue bar shows time until all HITs in each language were completed.}
