...
\caption{Time (in days) to complete HITS in each language. Tick marks represent the completion of individual HITs. Elapsed time is relative to the first submitted HIT across all languages (Urdu). }
