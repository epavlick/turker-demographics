...
\includegraphics[width=\linewidth]{figures/completiontime.pdf}
...
\begin{figure*}[h]
\centering
\includegraphics[width=6in]{figures/quality-hitlang-turkers}
\caption{Average estimated translation quality of by source language. Quality is calculated as the average number of control words which were correct translations of the source word, where "correct" means that the provided translation was judged to be synonymous with the known translation by workers in a second-pass HIT. Error bars show 95\% confidence intervals of the mean quality score across all translators for the language. Quality estimates are only show for languages with at least 50 active turkers. }
...
\begin{figure*}[h]
\centering
\includegraphics[width=6in]{figures/quality-scatter-avgturkers-country-labeled-turkers}
