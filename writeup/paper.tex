...
\includegraphics[width=6in]{figures/completiontime-series}
\caption{Time (in days) to complete the translation HITs for 40 of the languages in our study. Tick marks represent the completion of individual assignments. Urdu and Russian were the first languages to be launched, followed by the others 2 days later. The languages which completed in the shortest amount of time were 4 Indian languages and Macedonian.}
