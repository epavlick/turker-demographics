...
\begin{figure*}[h]
\centering
\includegraphics[width=\linewidth]{figures/turkermap-full}
\caption{The number of workers per country.  This map was generated based on geolocation of IP address of the 5284 workers in our study.  The size of the circles represents the number of worker from each country.  The two largest are India (2022 workers) and the United States (904).  To calibrate the sizes: the Philippines has 147 workers, Egypt has 25, Russia has 10, and Sri Lanka has 4.}
\label{map}
\end{figure*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
