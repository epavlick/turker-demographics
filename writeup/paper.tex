...
\caption{The number of workers per country.  This map was generated based on ((the self-reported location / geolocation of IP address)) of the XXXX workers in our study.  The size of the circles represents the number of worker from each country.  The two largest are India (1082 workers) and the United States (XXX).  To calibrate the sizes: the Philippines has XXX workers, Egypt has XXX, Russia has XXX, and Sri Lanka has XXX.}
\label{map}
\end{figure*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
