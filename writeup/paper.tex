...
\setlength\titlebox{5.4cm}    % Expanding the titlebox
...
\textbf{***Is this right? I think most of our tasks have 10 words per HIT.***}
...
Crowdsourced data has been used in a variety of machine learning applications, including computer vision (Sorokin et al.), paraphrasing (Nakov et al.) and sentiment analysis \cite{Snow2008}. More recently, in 2010, NAACL hosted a workshop on Creating Speech and Language Data with MTurk, in which MTurk was used to generate data for 24 different natural language tasks \cite{callisonburch-dredze:2010:MTURK}.
