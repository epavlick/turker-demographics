...
\end{tabular}
\normalsize
\caption{Self-reported native language of 3,154 bilingual Turkers. Not shown are 54 langs with $\leq$20 speakers  each for a total of 423 remaining speakers.  We omit Turkers did not self-report their native languages (1,801), 243 who reported two native languages, 83 who reported $\geq$3 native languages.}\label{lang-pie}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\caption{Time (in days) to complete all HITs in each language. Red bar shows time until first HIT was started,
% relative to the time the first HIT in each language was started, relative to the time the first HIT in any language was started (first HIT started across all languages was Urdu). 
 blue bar shows time until all HITs in each language were completed.}
