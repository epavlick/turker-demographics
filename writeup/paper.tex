...
We quantified the quality of each translation assignment based on the output of the quality assurance HIT by taking proportion of correct controls. A control was considered correct if it exactly matched the gold standard translation, or if it was judged to be synonymous with the correct translation. I.e.:
\begin{align}	
	\text{Quality}(a_i) = \frac{1}{k_i}\sum\limits_{j=1}^{k_i}\mathbf{1}(tr_{ij} \in \texttt{syns[$g_j$]})
\end{align}	
